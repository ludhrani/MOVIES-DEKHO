...
<body>
  ...
  <nav class="navbar navbar-inverse">
    <div class="container-fluid">
      ...
      <h1><b><a class="navbar-brand" style="padding-top: 11px; font-size:35px" href="index.php">MOVIES DEKHO</a></b></h1>
      ...
      ?>
        ...
        <i class="fa fa-user navbar-right" style="color:white;margin-top: 17px;margin-right: 5px;" aria-hidden="true"></i>
        </a>
      <?php } ?>
    </div>
  </nav>
